...
const experiences = [
  {
    ...
    description: "Engineered Spring Boot microservices integrating Kafka and H2 database to simulate scalable financial workflows.",
  },
  {
    role: "Software Engineering Micro Intern",
    company: "Deloitte Australia ",
    duration: "August 2025 - September 2025",
    description: "Designed scalable cloud solutions and enterprise security frameworks to address real-world business challenges.",
  },
  {
    role: "Summer Intern",
    company: "Airports Authority of India",
    duration: "June 2025 - July 2025",
    description: "Engineered anomaly detection pipelines processing 10,000+ records to identify failure patterns and optimize system reliability.",
  },
];
            ...
            {!isMobile && (
              <div className="relative w-full max-w-7xl">
                <div className="relative h-[6px] bg-white/15 rounded">
                  <motion.div
                    className="absolute left-0 top-0 bg-white rounded origin-left h-full"
